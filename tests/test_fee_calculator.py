...
class TestLehmanTiers:
    ...
    def test_single_tier_full_allocation(self, calculator):
        ...
        tiers = [
            LehmanTier(lower_bound=Decimal('0'), upper_bound=None, rate=Decimal('0.05'))
        ]
        result = calculator._calculate_lehman(
            deal_amount=Decimal('100000'),
            tiers=tiers,
            accumulated_before=Decimal('0')
        )
        assert result == Decimal('5000.00')
    ...
    def test_starts_in_second_tier(self, calculator):
        ...
        result = calculator._calculate_lehman(
            ...
            tiers=tiers,
            accumulated_before=Decimal('80000')
        )
    ...
    def test_already_in_highest_tier(self, calculator):
        ...
        result = calculator._calculate_lehman(
            deal_amount=Decimal('50000'),
            tiers=tiers,
            accumulated_before=Decimal('200000')
        )
        assert result == Decimal('1500.00')
